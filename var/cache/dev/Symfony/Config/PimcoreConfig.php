...
class PimcoreConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    */
    ...
    /**
     * @default {"image_thumbnails":{"write_target":{"type":"symfony-config","options":{"directory":"\/home\/hamzabaig\/pim\/var\/config\/image_thumbnails"}}},"video_thumbnails":{"write_target":{"type":"symfony-config","options":{"directory":"\/home\/hamzabaig\/pim\/var\/config\/video_thumbnails"}}},"document_types":{"write_target":{"type":"symfony-config","options":{"directory":"\/home\/hamzabaig\/pim\/var\/config\/document_types"}}},"predefined_properties":{"write_target":{"type":"symfony-config","options":{"directory":"\/home\/hamzabaig\/pim\/var\/config\/predefined_properties"}}},"predefined_asset_metadata":{"write_target":{"type":"symfony-config","options":{"directory":"\/home\/hamzabaig\/pim\/var\/config\/predefined_asset_metadata"}}},"perspectives":{"write_target":{"type":"symfony-config","options":{"directory":"\/home\/hamzabaig\/pim\/var\/config\/perspectives"}}},"custom_views":{"write_target":{"type":"symfony-config","options":{"directory":"\/home\/hamzabaig\/pim\/var\/config\/custom_views"}}},"object_custom_layouts":{"write_target":{"type":"symfony-config","options":{"directory":"\/home\/hamzabaig\/pim\/var\/config\/object_custom_layouts"}}},"system_settings":{"write_target":{"type":"symfony-config","options":{"directory":"\/home\/hamzabaig\/pim\/var\/config\/system_settings"}},"read_target":{"type":null,"options":{"directory":null}}},"select_options":{"write_target":{"type":"symfony-config","options":{"directory":"\/home\/hamzabaig\/pim\/var\/config\/select_options"}},"read_target":{"type":null,"options":{"directory":null}}}}
    */
